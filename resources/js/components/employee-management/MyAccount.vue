    ...
    <div class="container">
        <div class="content-header mb-3" style="border-bottom: 1px solid black;">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark" v-show="isEdit"><strong>Edit Account</strong></h4>
                        <h4 class="m-0 text-dark" v-show="!isEdit"><strong>My Account</strong></h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form @submit.prevent="createEmployee()">
                    <el-card class="box-card mb-3" shadow="hover">
                        ...
                        <el-form ref="form" :model="form" label-width="15%" :label-position="`right`">
                            ...
                            <el-form-item label="Current Password" v-show="isEdit">
                                <el-col :span="12">
                                    <el-input v-model="form.password" show-password></el-input>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="New Password" v-show="isEdit">
                                <el-col :span="12">
                                    <el-input v-model="form.new_password" show-password></el-input>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="Re-type Password" v-show="isEdit">
                                <el-col :span="12">
                    ...
                    <div class="outside-card-button" v-else>
                        <router-link :to="'/update-account/'+this.$route.params.employee_id">
