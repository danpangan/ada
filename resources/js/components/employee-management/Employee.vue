    ...
    <div class="container">
        <div class="content-header mb-3" style="border-bottom: 1px solid black;">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark" v-show="isEdit"><strong>Edit Employee</strong></h4>
                        <h4 class="m-0 text-dark" v-show="isAccountSetting"><strong>My Account</strong></h4>
                        <h4 class="m-0 text-dark" v-show="!isEdit && !isAccountSetting"><strong>View Employee</strong></h4>
                    </div>
                    <div class="col-sm-6" v-show="!isAccountSetting">
                ...
                <form @submit.prevent="createEmployee()">
                    <el-card class="box-card mb-3" shadow="hover">
                        ...
                        <el-form ref="form" :model="form" label-width="15%" :label-position="`right`">
                            <el-form-item label="Employee Number" prop="employee_number">
                                <el-col :span="12">
                                    <p>{{ form.employee_number }}</p>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="Username">
                                <el-col :span="12">
                                    <el-input v-model="form.username" :disabled="readonly"></el-input>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="Current Password" v-show="isAccountSetting">
                                <el-col :span="12">
                                    <el-input v-model="form.password" show-password></el-input>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="New Password" v-show="isAccountSetting">
                                <el-col :span="12">
                                    <el-input v-model="form.new_password" show-password></el-input>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="Re-type Password" v-show="isAccountSetting">
                                <el-col :span="12">
                                    <el-input v-model="form.retype_password" show-password></el-input>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="Reset Password" v-show="isEdit">
                                <el-col :span="12">
                                    <el-button type="danger" icon="el-icon-refresh-right" size="small" @click="resetPassword">Reset Password</el-button>
                                </el-col>
                            </el-form-item>
                        </el-form>
                    </el-card>
                    ...
                    <el-card class="box-card mb-3" shadow="hover">
                        ...
                        <el-form ref="form" :model="form" label-width="15%" :label-position="`right`">
                            <el-form-item label="First Name">
                                <el-col :span="12">
                                    <el-input v-model="form.first_name" :disabled="readonly"></el-input>
                                    <div v-if="errors && errors.first_name" class="text-danger">{{ errors.first_name[0] }}</div>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="Middle Name">
                                <el-col :span="12">
                                    <el-input v-model="form.middle_name" :disabled="readonly"></el-input>
                                    <div v-if="errors && errors.middle_name" class="text-danger">{{ errors.middle_name[0] }}</div>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="Last Name">
                                <el-col :span="12">
                                    <el-input v-model="form.last_name" :disabled="readonly"></el-input>
                            ...
                            <el-form-item label="Contact">
                                <el-col :span="12">
                                    <el-input v-model="form.contact" :disabled="readonly"></el-input>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="Birthday">
                                <el-col :span="4">
                                    <el-select v-model="form.month_value" placeholder="Month" :disabled="readonly">
                                        <el-option
                                ...
                                <el-col :span="4">
                                    <el-select v-model="form.day_value" placeholder="Day" :disabled="readonly">
                                        <el-option
                                        v-for="day in days"
                                        :key="day"
                                        :value="day">
                                ...
                                <el-col :span="4">
                                    <el-select v-model="form.year_value" placeholder="Year" :disabled="readonly">
                                        <el-option
                                        v-for="year in years"
                                        :key="year"
                                        :value="year">
                            ...
                            <el-form-item label="Gender">
                                <el-col :span="4">
                                    <el-select v-model="form.gender_value" placeholder="Gender" :disabled="readonly">
                                        <el-option
                            ...
                            <el-form-item label="Department">
                                <el-col :span="8">
                                    <el-select v-model="form.department_value" placeholder="Department" :disabled="readonly" class="el-col-24">
                                        <el-option 
                            ...
                            <el-form-item label="User Role">
                                <el-col :span="4">
                                    <el-select v-model="form.user_role" placeholder="User Role" :disabled="readonly">
                                        <el-option
                    ...
                    <el-card class="box-card mt-3" shadow="hover">
                        ...
                        <div v-for="permission in form.permissions" :key="permission.id">
                            <el-collapse v-model="activePermissions" v-show="!isEdit && permission[0].isSelected == true || !isAccountSetting && permission[0].isSelected == true || isEdit">
                                <el-collapse-item :name="permission[0].permission_description" disabled>
                                    ...
                                    <el-row :gutter="20" v-for="item in permission" :key="item.permission_id" class="permission-row">
                                        <el-col :span="16" v-show="!isEdit && item.isSelected == true || !isAccountSetting && item.isSelected == true || isEdit">
                                            <div v-if="!item.isTitle" class="ml-3">{{ item.permission_description }}</div>
                                        </el-col>
                                        <el-col :span="8" v-show="!isEdit && item.isSelected == true || !isAccountSetting && item.isSelected == true || isEdit">
                    ...
                    <div class="outside-card-button" v-if="isEdit">
                        <el-button type="primary" v-on:click="updateEmployee"><i class="el-icon-circle-check"></i> Update</el-button>
                    ...
                    <div class="outside-card-button" v-else>
                        <router-link :to="'/update-employee/'+this.$route.params.employee_id">
...
<script>
    export default {
        ...
        methods: {
            updateEmployee() {
                ...
                .then((result) => {
                    if(result.value){
                        this.isLoading = true;
                        this.form.put('/api/user/'+this.$route.params.employee_id)
                        .then(() => {
                            Swal.fire(
                                'Updated!',
            ...
            getEmployee(){
                axios.get('/api/user/'+this.$route.params.employee_id)
                .then((res) => {
                    this.form.fill(res.data);
                    this.form.month_value = parseInt(res.data.birthdate.substr(5, 6));
                    this.form.day_value = parseInt(res.data.birthdate.substr(8, 9));
                    this.form.year_value = parseInt(res.data.birthdate.substr(0, 4));
                    this.form.gender_value = res.data.gender;
                    this.form.department_value = res.data.department_id;
                    this.form.department_name = res.data.department.department_name;
                    this.loadPermissions();
                    this.activePermissions = [];
            ...
            resetPassword(){
                ...
                .then((result) => {
                    if(result.value){
                        axios.post('/api/reset-password/'+this.form.employee_number)
                        .then(() => {
                            Swal.fire(
                                'Updated!',
            ...
            exportPDF(){
                ...
                window.open('/export-pdf-employee?employee_number='+employee_number);
            },
            toEdit(){
                this.isEdit = true;
            },
        ...
        computed: {
            readonly(){
                if(!this.isEdit && !this.isAccountSetting) return true;
            },
        },
        watch:{
            $route (to, from){
