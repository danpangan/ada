    ...
    <div class="container">
        <div class="content-header mb-3" style="border-bottom: 1px solid black;">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark" v-show="isEdit"><strong>Edit Order</strong></h4>
                        <h4 class="m-0 text-dark" v-show="!isEdit"><strong>View Order</strong></h4>
                    </div>
                    <div class="col-sm-6">
                ...
                <form @submit.prevent="updateOrder()">
                    <el-card class="box-card" shadow="hover">
                        ...
                        <el-form ref="form" :model="form" label-width="15%" :label-position="`right`">
                            <el-form-item label="Part Number">
                                <el-col :span="12">
                                    <el-input v-model="form.order.order_part_number" :disabled="readonly"></el-input>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="Order Description">
                                <el-col :span="12">
                                    <el-input v-model="form.order.order_item_description" :disabled="readonly"></el-input>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="Order Currency">
                                <el-col :span="24">
                                    <el-radio v-model="form.order.order_currency" label="PHP" :disabled="readonly">PHP</el-radio>
                                    <el-radio v-model="form.order.order_currency" label="USD" :disabled="readonly">USD</el-radio>
                                </el-col>
                            </el-form-item>
                            <el-form-item label="Order Category">
                                <el-col :span="6">
                                    <el-select v-model="form.order.order_category" placeholder="Category" :disabled="readonly">
                                        <el-option
                            ...
                            <el-form-item label="Item Type Code">
                                <el-col :span="6">
                                    <el-select v-model="form.order.order_item_type_code" @change="selectTypeCode" :disabled="disableTypeCode || readonly" placeholder="Category">
                                        <el-option
                                ...
                                <el-col :span="6" v-show="form.order.order_item_type_code && !readonly">
                            ...
                            <div v-show="isVisiblelassificationsSetting">
                                ...
                                <el-form-item label="Add Classification">
                                    <el-col :span="8">
                                        <el-input :span="8" v-model="classificationForm.material_classification_name" :disabled="readonly">
                                        </el-input>
                                    </el-col>
                                    <el-col :span="12">
                            ...
                            <el-form-item label="Item Classification">
                                <el-col :span="6">
                                    <el-select v-model="form.order.order_item_classification" :disabled="classifications.length == 0 || readonly" placeholder="Category">
                                        <el-option
                            ...
                            <el-form-item label="Order Dimension">
                                <el-col :span="4">
                                    <el-input v-model="form.order.order_length" :disabled="readonly"></el-input>
                                </el-col>
                                <el-col :span="4">
                                    <el-select v-model="form.order.order_length_unit" placeholder="Unit" :disabled="readonly">
                                        <el-option
                                ...
                                <el-col :span="4">
                                    <el-input v-model="form.order.order_width" :disabled="readonly"></el-input>
                                </el-col>
                                <el-col :span="4">
                                    <el-select v-model="form.order.order_width_unit" placeholder="Unit" :disabled="readonly">
                                        <el-option
                                        v-for="unit in $units_dimension"
                                        :key="unit.id"
                                        :label="unit.unit_name"
                            ...
                            <el-form-item label="Order Gap">
                                <el-col :span="4">
                                    <el-input v-model="form.order.order_gaplr" :disabled="readonly"></el-input>
                                </el-col>
                                <el-col :span="4">
                                    <el-select v-model="form.order.order_gaplr_unit" placeholder="Unit" :disabled="readonly">
                                        <el-option
                                        v-for="unit in $units_dimension"
                                        :key="unit.id"
                                        :label="unit.unit_name"
                                ...
                                <el-col :span="4">
                                    <el-input v-model="form.order.order_gaptb" :disabled="readonly"></el-input>
                                </el-col>
                                <el-col :span="4">
                                    <el-select v-model="form.order.order_gaptb_unit" placeholder="Unit" :disabled="readonly">
                                        <el-option
                                        v-for="unit in $units_dimension"
                                        :key="unit.id"
                                        :label="unit.unit_name"
                    ...
                    <el-card class="box-card mt-3" shadow="hover">
                        ...
                        <el-form ref="form" :model="form" label-width="15%" :label-position="`right`">
                            ...
                            <el-form-item label="Material Name">
                                <el-col :span="18">
                                    <el-select v-model="form.subcontractor_material.material_id" placeholder="Material Name" @change="selectSubcontractMaterial" class="block" :disabled="readonly">
                                        <el-option
                            ...
                            <el-form-item label="Specifications">
                                <el-col :span="20">
                                    ...
                                    <el-col :span="4">
                                        <el-input v-model="form.subcontractor_material.order_material_length" :disabled="readonly"></el-input>
                                    </el-col>
                                    <el-col :span="4">
                                        <el-select v-model="form.subcontractor_material.order_material_length_unit" placeholder="Unit" :disabled="readonly">
                                            <el-option
                                            v-for="unit in $units_dimension"
                                            :key="unit.id"
                                            :label="unit.unit_name"
                                    ...
                                    <el-col :span="4">
                                        <el-input v-model="form.subcontractor_material.order_material_width" :disabled="readonly"></el-input>
                                    </el-col>
                                    <el-col :span="4">
                                        <el-select v-model="form.subcontractor_material.order_material_width_unit" placeholder="Unit" :disabled="readonly">
                                            <el-option
                                            v-for="unit in $units_dimension"
                                            :key="unit.id"
                                            :label="unit.unit_name"
                            ...
                            <el-col :span="24" class="text-center mb-3" v-show="isEdit">
                                    ...
                                    <el-table-column type="expand">
                                        <template slot-scope="props">
                                            ...
                                            <el-row>
                                                ...
                                                <el-col :span="20">
                                                    <p>{{ fetchMachineName(props.row.order_print_machine_id) }}</p>
                                                </el-col>
                                            </el-row>
                                            <el-row>
                                                <el-col :span="4">
                        ...
                        <!-- Start Hide Div -->
                            <div v-if="isEdit">
                                ...
                                <el-form-item label="Remarks">
                                    <el-col :span="12">
                                        <el-input v-model="draft_process.remarks"></el-input>
                                    </el-col>
                                </el-form-item>
                                <el-form-item label="Specifications">
                                    <el-col :span="21">
                                       ...
                                       <!-- Expandables -->
                                        ...
                                        <template slot-scope="props">
                                            ...
                                            <el-row>
                                                ...
                                                <el-col :span="20">
                                                    <p>{{ props.row.order_process_cuts }}</p>
                                                </el-col>
                                            </el-row>
                                            <el-row>
                                                <el-col :span="4">
                                                ...
                                                <el-col :span="20">
                                                    <p>{{ props.row.order_process_outs }}</p>
                                                </el-col>
                                            </el-row>
                                            <el-row>
                                                <el-col :span="4">
                                                ...
                                                <el-col :span="20">
                                                    <p>{{ props.row.order_process_folds }}</p>
                                                </el-col>
                                            </el-row>
                                            <el-row>
                                                <el-col :span="4">
                                                ...
                                                <el-col :span="20">
                                                    <p>{{ props.row.order_process_paper_size }}</p>
                                                </el-col>
                                            </el-row>
                                            <el-row>
                                                <el-col :span="4">
                                                ...
                                                <el-col :span="20">
                                                    <p>{{ props.row.order_process_signature }}</p>
                                                </el-col>
                                            </el-row>
                                            <el-row>
                                                <el-col :span="4">
                                                ...
                                                <el-col :span="20">
                                                    <p>{{ props.row.order_process_gsm }}</p>
                                                </el-col>
                                            </el-row>
                                        </template>
                                        </el-table-column>
        ...
        methods: {
            updateOrder() {
                ...
                .then((result) => {
                    if(result.value){
                        this.isLoading = true;
                        this.form.put('/api/order/'+this.$route.params.order_id)
                        .then((res) => {
                            Swal.fire(
                                'Updated!',
            ...
            getOrder(){
                axios.get('/api/order/'+this.$route.params.order_id)
                .then((res) => {
                    this.form.fill(res.data);
                    this.fillPrintingMaterials();
                    this.selectTypeCode();
                })
                .catch((error) => {
                    console.log(error)
            ...
            exportPDF(){
                ...
                window.open('/export-pdf-order?order_id='+order_id);
            },
            toEdit(){
                this.isEdit = true;
            },
            ...
            initializeSubcontractorProcessTable(){
                this.form.draft_process_subcon          = {
                    description: '',
                    process_name: '',
                }
            },
                ...
                .then((result) => {
                    if(result.value){
                        ...
                        this.form.process_list.push({
                            ...
                            'order_process_id': this.draft_process.process_id,
                            'order_process_remarks': this.draft_process.remarks,
                            'process_name': this.draft_process.process_name,
                            'order_process_cuts': this.draft_process.cuts,
                            'order_process_outs': this.draft_process.outs,
                            'order_process_folds': this.draft_process.folds,
                            'order_process_paper_size': this.draft_process.size,
                            'order_process_signature': this.draft_process.sig,
                            'order_process_gsm': this.draft_process.gsm,
                            'deleted_at': null,
                        });
            ...
            fetchMachineName(machine_id){
                let machine_object = _.find(this.$machines, { 'id': machine_id });
                return machine_object.machine_name;
            },
            fillPrintingMaterials(){
                for(let i = 0; i < this.form.primary_materials.length; i++) {
                    let material_object = _.find(this.materials, { 'id': this.form.primary_materials[i].material_id });

                    if(!_.find(this.printing_materials, { 'material_id': this.form.primary_materials[i].material_id })){
                        let printing_material_id = 1;
                        if(this.printing_materials.length > 0) printing_material_id = this.printing_materials[this.printing_materials.length - 1].id + 1;
                        this.printing_materials.push({
                            'id': printing_material_id,
                            'material_id': this.form.primary_materials[i].material_id,
                            'material_name': material_object.material_description,
                            'order_material_length': material_object.material_length,
                            'order_material_length_unit': material_object.material_length_unit,
                            'order_material_width': material_object.material_width,
                ...
                for(let i = 0; i < this.form.secondary_materials.length; i++) {
                    let material_object = _.find(this.materials, { 'id': this.form.secondary_materials[i].material_id });

                    if(!_.find(this.printing_materials, { 'material_id': this.form.secondary_materials[i].material_id })){
                        let printing_material_id = 1;
                        if(this.printing_materials.length > 0) printing_material_id = this.printing_materials[this.printing_materials.length - 1].id + 1;
                        this.printing_materials.push({
                            'id': printing_material_id,
                            'material_id': this.form.secondary_materials[i].material_id,
                            'material_name': material_object.material_description,
                            'order_material_length': material_object.material_length,
                            'order_material_length_unit': material_object.material_length_unit,
                            'order_material_width': material_object.material_width,
                ...
                .then((result) => {
                    if(result.value){
                        for(let i = 0; i < this.form.process_subcon.length; i++){
                            if(this.form.process_subcon[i].id == id){
                                this.form.process_subcon.splice(i, 1);
                            }
                        }
                ...
                .then((result) => {
                    if(result.value){
                        ...
                        this.form.process_subcon.push({
                            ...
                            'order_process_subcon': this.draft_process_subcon.process_name,
                            'order_process_subcon_description': this.draft_process_subcon.description,
                            'deleted_at': null,
