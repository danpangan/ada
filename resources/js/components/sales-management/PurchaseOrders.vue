        ...
        <div class="content-header mb-3" style="border-bottom: 1px solid black;">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <router-link :to="'/add-po'">
                            <button type="submit" class="btn btn-add btn-sm float-right">
                                <i class="fas fa-plus mr-1"></i> Add New PO
                            </button>
                        </router-link>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <el-table
                            v-model="purchaseOrderTable"
                            row-key="purchaseOrderTableId"
                            height="500px"
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    <el-tooltip class="item" effect="dark" content="More info" placement="top">
                                        <router-link :to="'/view-po/'+purchaseOrderTable[scope.$index].id">
                                    ...
                                    <el-tooltip class="item" effect="dark" content="Edit" placement="top" v-show="!showDeleted">
                                        <router-link :to="'/update-po/'+purchaseOrderTable[scope.$index].id">
                                    ...
                                    <el-tooltip class="item" effect="dark" content="Copy" placement="top" v-show="!showDeleted">
                                        <router-link :to="'/update-po/'+purchaseOrderTable[scope.$index].id">
                                            <i class="icon el-icon-document-copy pointer ml-2"></i>
                                        </router-link>
                                    </el-tooltip>

                                    <el-tooltip class="item" effect="dark" content="Delete" placement="top" v-if="!showDeleted">
                                        <i class="icon el-icon-delete pointer ml-2" @click="deletePO(purchaseOrderTable[scope.$index].id)"></i>
                                    </el-tooltip>
                                    <el-tooltip class="item" effect="dark" content="Restore" placement="top" v-else>
                                        <i class="icon el-icon-circle-check pointer ml-2" @click="deletePO(purchaseOrderTable[scope.$index].id)"></i>
                                    </el-tooltip>
                                </template>
                            </el-table-column>
                        </el-table>
        ...
        methods: {
            getSuppliers(){
                ...
                .then((data) => {
                    ...
                    if(this.$currentPageSuppliers > 0){
                        ...
                        this.purchaseOrderTable = data.data.data;
                        this.pageInfo = data.data;
            ...
            deletePO(po_id){
                ...
                .then((result) => {
                    if(result.value){
                        this.loading = true;
                        axios.delete('api/purchase-order/'+po_id)
                        .then((data) => {
                            Swal.fire(
                                'Success!',
                                'PO has been '+this.alert_text+'d.',
                                'success'
                            )
                            this.getSuppliers();
                            this.loading = false;
                        ...
                        .catch((error) => {
                            Swal.fire(
                                'Failed!',
                                'Failed to '+this.alert_text+' purchase order.',
                                'warning'
                            )
                            this.loading = false;
                        })
