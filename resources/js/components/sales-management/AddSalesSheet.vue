    ...
    <div class="container">
        <div class="content-header mb-3" style="border-bottom: 1px solid black;">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark"><strong>Add Sales Sheet</strong></h4>
                    </div>
                    <div class="col-sm-6">
                ...
                <form @submit.prevent="createSS()">
                    <el-card class="box-card" shadow="hover">
                        ...
                        <el-form ref="form" :model="form" label-width="15%" :label-position="`right`">
                            ...
                            <el-form-item label="Customer Name">
                                <el-col :span="12">
                                    <el-select v-model="form.dummy_date" placeholder="Part Number" class="block">
                                        <el-option
                                    ...
                                    <el-table-column label="Action" fixed="right" width="70">
                                        <template slot-scope="scope">
                                            <el-tooltip class="item" effect="dark" content="Delete" placement="top">
                                                <i class="icon el-icon-delete pointer ml-2" @click="deleteCSEvaluator(form.ss_evaluation_checkers[scope.$index].evaluator_id, 'checker')"></i>
                                            </el-tooltip>
                                        </template>
                                    </el-table-column>
                                </el-table>
                            ...
                            <el-col :span="12">
                                <el-table
                                    ...
                                    <el-table-column label="Action" fixed="right" width="70">
                                        <template slot-scope="scope">
                                            <el-tooltip class="item" effect="dark" content="Delete" placement="top">
                                                <i class="icon el-icon-delete pointer ml-2" @click="deleteCSEvaluator(form.ss_evaluation_approvers[scope.$index].evaluator_id, 'approver')"></i>
                                            </el-tooltip>
                                        </template>
                                    </el-table-column>
                                </el-table>
                    ...
                    <div class="outside-card-button">
                        <el-button type="primary" v-on:click="createSS"><i class="el-icon-plus"></i> Create</el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
            createSS() {
                Swal.fire({
                    text: 'Are you sure you want to register new Sales Sheet?',
                    icon: 'question',
                ...
                .then((result) => {
                    if(result.value){
                        this.form.post('/api/sales-sheet')
                        .then((res) => {
                            Swal.fire(
                                'Registered!',
                                'Sales sheet successfully registered.',
                                'success'
                            )
                        })
                        .catch(error => {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Oops!',
                                text: 'Sales sheet registration failed.',
                            });
                        });
                    }
                });
