            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-adamay-blue">
                        <h3 class="card-title">Customer Sales Sheets</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <el-table
                            ...
                            <el-table-column
                                prop="ss_qty_remaining"
                                label="SS Remaining Quantity"
                                width="160"
                                sortable>
                            </el-table-column>
                            <el-table-column
                                prop="ss_payment_method"
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    ...
                                    <el-tooltip class="item" effect="dark" content="Delete" placement="top" v-if="!showDeleted">
                                        <i class="icon el-icon-delete pointer ml-2" @click="deleteSS(tableData[scope.$index].id)"></i>
                                    </el-tooltip>
                                    <el-tooltip class="item" effect="dark" content="Restore" placement="top" v-else>
                                        <i class="icon el-icon-circle-check pointer ml-2" @click="deleteSS(tableData[scope.$index].id)"></i>
                                    </el-tooltip>
                                </template>
                            </el-table-column>
                        </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            getClientSS(){
                ...
                .then((data) => {
                    this.pageInfo = data.data.ss;
                    this.tableData = data.data.ss.data;
            ...
            exportPDF(){
                ...
                window.open('/export-pdf-customer-sales-monitoring-ss?keywords='+keywords+'&showDeleted='+isDeleted+'&sortProp='+sortProp+'&sortOrder='+sortOrder+'&clientId='+clientId);
            },
            sortChange(param){
