            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-adamay-blue">
                        <h3 class="card-title">Customer Delivery Monitoring</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <el-table
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    <el-col :span="12">
                                        {{ tableData[scope.$index].delivery_qty+' '}}
                                        {{ qtyLabel(tableData[scope.$index].quantity_unit) }}
                                    </el-col>
                                </template>
                            </el-table-column>
                            <el-table-column
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    ...
                                    <el-tooltip class="item" effect="dark" content="Delete" placement="top" v-if="!showDeleted">
                                        <i class="icon el-icon-delete pointer ml-2" @click="deleteDM(tableData[scope.$index].id)"></i>
                                    </el-tooltip>
                                    <el-tooltip class="item" effect="dark" content="Restore" placement="top" v-else>
                                        <i class="icon el-icon-circle-check pointer ml-2" @click="deleteDM(tableData[scope.$index].id)"></i>
                                    </el-tooltip>
                                </template>
                            </el-table-column>
                        </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            getClientDM(){
                ...
                .then((data) => {
                    this.pageInfo = data.data.dm;
                    this.tableData = data.data.dm.data;
            ...
            handleSizeChange(val) {
                ...
                .then((data) => {
                    this.tableData = data.datadm.data;
                    this.pageInfo = data.datadm;
                    this.loading = false;
                })
                .catch((error) => {
                    this.loading = false;
            ...
            exportPDF(){
                ...
                window.open('/export-pdf-customer-sales-monitoring-dm?keywords='+keywords+'&showDeleted='+isDeleted+'&sortProp='+sortProp+'&sortOrder='+sortOrder+'&clientId='+clientId);
            },
            sortChange(param){
                ...
                .then((result) => {
                    if(result.value){
                        ...
                        .then((data) => {
                            Swal.fire(
                                'Success!',
                                'Delivery Monitoring has been '+this.alert_text+'d.',
                                'success'
                            )
                            this.getClientDM();
                            this.loading = false;
                        ...
                        .catch((error) => {
                            Swal.fire(
                                'Failed!',
                                'Failed to '+this.alert_text+' delivery monitoring.',
                                'warning'
                            )
                            this.loading = false;
                        })
