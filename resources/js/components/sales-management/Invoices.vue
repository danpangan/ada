                    ...
                    <div class="col-sm-6">
                        <router-link :to="'/add-invoice'">
                            <button type="submit" class="btn btn-add btn-sm float-right">
                                <i class="fas fa-plus mr-1"></i> Add New Invoice
                            </button>
                        </router-link>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <el-table
                            v-model="InvoiceTable"
                            row-key="InvoiceTableId"
                            height="500px"
                            :data="InvoiceTable"
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    <el-tooltip class="item" effect="dark" content="More info" placement="top">
                                        <router-link :to="'/view-invoice/'+InvoiceTable[scope.$index].id">
                                    ...
                                    <el-tooltip class="item" effect="dark" content="Edit" placement="top" v-show="!showDeleted">
                                        <router-link :to="'/update-invoice/'+InvoiceTable[scope.$index].id">
                                    ...
                                    <el-tooltip class="item" effect="dark" content="Delete" placement="top" v-if="!showDeleted">
                                        <i class="icon el-icon-delete pointer ml-2" @click="deleteInvoice(InvoiceTable[scope.$index].id)"></i>
                                    </el-tooltip>
                                    <el-tooltip class="item" effect="dark" content="Restore" placement="top" v-else>
                                        <i class="icon el-icon-circle-check pointer ml-2" @click="deleteInvoice(InvoiceTable[scope.$index].id)"></i>
                                    </el-tooltip>
                                </template>
                            </el-table-column>
                        </el-table>
                        ...
                        <el-col class="show-deleted-checkbox" :span="6">
                            <el-checkbox v-model="showDeleted" @change="showDeletedOrders">Show deleted invoices</el-checkbox>
                        </el-col>
                    </div>
        ...
        methods: {
            getSuppliers(){
                ...
                .then((data) => {
                    ...
                    if(this.$currentPageInvoices > 0){
                        this.handleCurrentChange(this.$currentPageInvoices);
                    }
                    else{
                        this.InvoiceTable = data.data.data;
                        this.pageInfo = data.data;
                        this.pageInfo.current_page = this.$currentPageInvoices;
                        this.loading = false;   
                    }      
                })
                .catch(error => {
            ...
            deleteInvoice(supplier_id){
                ...
                .then((result) => {
                    if(result.value){
                        this.loading = true;
                        axios.delete('api/invoice/'+supplier_id)
                        .then((data) => {
                            Swal.fire(
                                'Success!',
                                'Invoice has been '+this.alert_text+'d.',
                                'success'
                            )
                            this.getSuppliers();
                            this.loading = false;
                        ...
                        .catch((error) => {
                            Swal.fire(
                                'Failed!',
                                'Failed to '+this.alert_text+' invoice.',
                                'warning'
                            )
                            this.loading = false;
                        })
            ...
            exportPDF(){
                ...
                window.open('/export-pdf-invoices?keywords='+keywords+'&showDeleted='+isDeleted+'&sortProp='+sortProp+'&sortOrder='+sortOrder);
            },
            sortChange(param){
            ...
            currentPageGlobal(){
                Vue.prototype.$currentPageInvoices = this.pageInfo.current_page;
